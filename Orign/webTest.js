...
// app.post('/stug',function(req,res){
...
app.get('/stug',stuController.findone)

app.get('/stus',stuController.findcount)

app.get('/stup',stuController.findoneupdate)

app.get('/stun',stuController.findonebacknicecount)

app.get('/stum',stuController.findbackmymaps)
